...
> **Note (personal fork):** Telemetry is disabled by default in this fork. I use this purely for local learning and experimentation and do not intend to collect or transmit any data.
